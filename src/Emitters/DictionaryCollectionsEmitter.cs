...
internal static class DictionaryCollectionsEmitter
{
    ...
    public static void EmitDictionaryCollections(StringBuilder sb)
    {
        ...
        sb.AppendLine("\t\t[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining | System.Runtime.CompilerServices.MethodImplOptions.AggressiveOptimization)]");
        sb.AppendLine("\t\tpublic static Dictionary<TKey, TValue> Adapt<TKey, TValue>(this Dictionary<TKey, TValue> source) where TKey : notnull");
        sb.AppendLine("\t\t{");
        ...
        sb.AppendLine("\t\tpublic static SortedDictionary<TKey, TValue> Adapt<TKey, TValue>(this SortedDictionary<TKey, TValue> source) where TKey : notnull");
        sb.AppendLine("\t\t{");
        sb.AppendLine("\t\t\tif (source is null) throw new ArgumentNullException(nameof(source));");
        ...
        sb.AppendLine("\t\t[ExcludeFromCodeCoverage]");
        sb.AppendLine("\t\t[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]");
        sb.AppendLine("\t\tpublic static ConcurrentDictionary<TKey, TValue> Adapt<TKey, TValue>(this ConcurrentDictionary<TKey, TValue> source) where TKey : notnull");
        sb.AppendLine("\t\t{");
        sb.AppendLine("\t\t\tif (source is null) throw new ArgumentNullException(nameof(source));");
        ...
        sb.AppendLine("\t\t[ExcludeFromCodeCoverage]");
        sb.AppendLine("\t\t[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]");
        sb.AppendLine("\t\tpublic static ImmutableDictionary<TKey, TValue> Adapt<TKey, TValue>(this ImmutableDictionary<TKey, TValue> source) where TKey : notnull");
        sb.AppendLine("\t\t{");
        sb.AppendLine("\t\t\tif (source is null) throw new ArgumentNullException(nameof(source));");
        ...
        sb.AppendLine("\t\t[ExcludeFromCodeCoverage]");
        sb.AppendLine("\t\t[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]");
        sb.AppendLine("\t\tpublic static ImmutableSortedDictionary<TKey, TValue> Adapt<TKey, TValue>(this ImmutableSortedDictionary<TKey, TValue> source) where TKey : notnull");
        sb.AppendLine("\t\t{");
        sb.AppendLine("\t\t\tif (source is null) throw new ArgumentNullException(nameof(source));");
        sb.AppendLine("\t\t\treturn source;");
        sb.AppendLine("\t\t}");
