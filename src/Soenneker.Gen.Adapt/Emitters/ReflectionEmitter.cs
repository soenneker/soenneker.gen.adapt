...
internal static class ReflectionEmitter
{
    ...
    public static void EmitReflectionAdapter(StringBuilder sb, string targetNamespace)
    {
        ...
        sb.AppendLine("\t\t\t\t\t\t});");
        sb.AppendLine("\t\t\t\t\t}");
        sb.AppendLine("\t\t\t\t\telse if (Nullable.GetUnderlyingType(sourceProp.PropertyType) is Type sourceUnderlying &&");
        sb.AppendLine("\t\t\t\t\t         sourceUnderlying == destProp.PropertyType)");
        sb.AppendLine("\t\t\t\t\t{");
        sb.AppendLine("\t\t\t\t\t\tactions.Add((src, dst) =>");
        sb.AppendLine("\t\t\t\t\t\t{");
        sb.AppendLine("\t\t\t\t\t\t\tvar value = sourceProp.GetValue(src);");
        ...
        sb.AppendLine("\t\t\t\t\t\t});");
        sb.AppendLine("\t\t\t\t\t}");
        sb.AppendLine("\t\t\t\t\telse if (Nullable.GetUnderlyingType(destProp.PropertyType) is Type destUnderlying &&");
        sb.AppendLine("\t\t\t\t\t         destUnderlying == sourceProp.PropertyType)");
        sb.AppendLine("\t\t\t\t\t{");
        sb.AppendLine("\t\t\t\t\t\tactions.Add((src, dst) =>");
        sb.AppendLine("\t\t\t\t\t\t{");
        sb.AppendLine("\t\t\t\t\t\t\tvar value = sourceProp.GetValue(src);");
