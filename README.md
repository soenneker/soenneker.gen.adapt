...
| Method              |      Mean |        Ratio | Allocated | Alloc Ratio |
| ------------------- | --------: | -----------: | --------: | ----------: |
| Soenneker.Gen.Adapt |  6.549 탎 |     baseline |  46.93 KB |             |
| AutoMapper          | 10.655 탎 | 1.64x slower |  55.27 KB |  1.18x more |
| Mapster             |  7.196 탎 | 1.11x slower |  46.93 KB |  1.00x more |
| Mapperly            |  6.974 탎 | 1.07x slower |  46.93 KB |  1.00x more |
...
| Method              |     Mean |        Ratio | Allocated | Alloc Ratio |
| ------------------- | -------: | -----------: | --------: | ----------: |
| Soenneker.Gen.Adapt | 1.033 탎 |     baseline |   7.87 KB |             |
| AutoMapper          | 1.690 탎 | 1.65x slower |   9.17 KB |  1.17x more |
| Mapster             | 1.175 탎 | 1.14x slower |   7.87 KB |  1.00x more |
| Mapperly            | 1.143 탎 | 1.11x slower |   7.87 KB |  1.00x more |
...
?? Note: Source Generators don뭪 work transitively across project references.
